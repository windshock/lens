...
| FR-016 | 결정론적 override는 LLM보다 우선해야 한다. | O0/O1/O1-whois/O1-whois-transitive/O1-infra-corroboration/O2/O3/O4/O7/D1/O5/O6/O8-saas/O9-first-party-install/O10-model-consistency/O11-third-party-form-provider/O12-third-party-provider-page/O13-established-kr-registrant의 우선순위와 safe/danger 충돌 규칙 유지 |
