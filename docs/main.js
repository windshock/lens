const translations = {
  en: {
    metaDescription: "Windshock Lens is a Chrome MV3 extension that helps detect gray-zone phishing and scam pages inside the browser with on-device AI and deterministic security rules.",
    navWhy: "Why",
    ...
    whyBody: "Modern phishing pages abuse normal infrastructure, imitate trusted software, and adapt their login screens after rendering. Windshock Lens was shaped by field observations of AI client impersonation, fake software download pages, and enterprise sign-in phishing kits.",
    ...
    focusBody: "Windshock Lens is not a replacement for Chrome Safe Browsing, a cloud scanner, a generic antivirus, or a thin LLM wrapper. It is a local triage layer for suspicious rendered pages that need evidence-aware judgment before the user continues.",
    ...
    workflowTitle: "How Windshock Lens evaluates a page",
    ...
    roadmapBody: "Windshock Lens targets the gray-zone phishing that Chrome Safe Browsing tends to miss. The list below tracks what is already in production and what is still open.",
    roadmapItem1: "Shipped: Hard-evidence precheck before LLM analysis (v0.1.29).",
    roadmapItem2: "Shipped: Phishing-kit signature markers including Telegram and Discord exfiltration patterns.",
    roadmapItem3: "Shipped: Single-flight scan deduplication and a Built-in AI compatibility diagnostic page for team rollout (v0.2.3).",
    roadmapItem4: "Open: Privacy-first endpoint metadata observation (URL and header level only, no page body content). Chrome Web Store submission is tracked separately in issue #6.",
    roadmapLink: "Track Chrome Web Store launch (issue #6)",
    footerText: "Defensive research project for browser-side phishing triage."
  },
  ko: {
    metaDescription: "Windshock Lens는 온디바이스 AI와 결정론적 보안 규칙으로 브라우저 안에서 그레이존 피싱 및 스캠 페이지를 탐지하는 Chrome MV3 확장 프로그램입니다.",
    navWhy: "배경",
    navWorkflow: "동작 방식",
    navSignals: "탐지 신호",
    navRoadmap: "로드맵",
    ...
    whyBody: "현대 피싱 페이지는 정상 인프라를 악용하고 신뢰받는 소프트웨어를 흉내 내며 렌더링 이후 로그인 화면을 동적으로 바꿉니다. Windshock Lens는 AI 클라이언트 사칭, 가짜 소프트웨어 다운로드 페이지, 엔터프라이즈 로그인 피싱 킷 관찰에서 출발했습니다.",
    ...
    focusBody: "Windshock Lens는 Chrome Safe Browsing, 클라우드 스캐너, 범용 백신, 단순 LLM 래퍼를 대체하지 않습니다. 사용자가 계속 진행하기 전에 증거 기반 판단이 필요한 의심 렌더링 페이지를 로컬에서 평가하는 보조 계층입니다.",
    ...
    workflowTitle: "Windshock Lens가 페이지를 평가하는 방법",
    ...
    roadmapTitle: "로드맵",
    roadmapBody: "Windshock Lens 는 Chrome Safe Browsing 이 잡지 못하는 그레이존 피싱을 대상으로 합니다. 아래는 이미 출시된 항목과 아직 열려 있는 항목입니다.",
    roadmapItem1: "출시: LLM 분석 전 명확한 증거 사전 검사 (v0.1.29).",
    roadmapItem2: "출시: 피싱 킷 시그니처 마커 — Telegram / Discord 유출 패턴 등 포함.",
    roadmapItem3: "출시: 동일 URL 동시 스캔 single-flight 통합 + 팀 배포용 Built-in AI 호환성 진단 페이지 (v0.2.3).",
    roadmapItem4: "열림: 프라이버시 우선 엔드포인트 메타데이터 관찰 (URL·헤더 수준만, 페이지 본문 미포함). Chrome Web Store 제출은 이슈 #6 에서 별도로 추적.",
    roadmapLink: "Chrome Web Store 출시 추적 (이슈 #6)",
...
function applyLanguage(lang) {
  ...
  document.title = lang === "ko" ? "Windshock Lens | 한국어 소개" : "Windshock Lens";
