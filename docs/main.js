const translations = {
  en: {
    ...
    roadmapBody: "Windshock Lens is intended for security research, pilot testing, and defensive evaluation. It is not yet an enterprise-managed security product.",
  ...
  ko: {
    ...
    roadmapBody: "Windshock Lens는 보안 연구, 파일럿 테스트, 방어적 평가를 위한 프로젝트입니다. 아직 엔터프라이즈 관리형 보안 제품은 아닙니다.",
