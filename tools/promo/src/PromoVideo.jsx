...
import { Watermark, FadeOutOverlay } from "remotion-kit-lib";
...
// Watermark + FadeOutOverlay 는 remotion-kit-lib 의 공용 컴포넌트.
...
export const PromoVideo = ({ lang }) => {
  ...
  return (
    <AbsoluteFill style={{ background: "#0b1220" }}>
      ...
      <Watermark text="windshock.github.io/lens" position="br" />

      {/* Final fade-to-black — must come last so it covers Watermark too */}
      <FadeOutOverlay fadeDuration={20} />
    </AbsoluteFill>
  );
};
